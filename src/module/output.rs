...
impl Default for PortAudioOut {
    fn default() -> Self {
        ...
        let settings = pa::stream::OutputSettings::new(output_params, SAMPLE_RATE as f64, (BUFFER_SIZE * CHUNK_SIZE) as u32);
...
impl Module for PortAudioOut {
    ...
    fn process_chunks(&mut self, input: &Vec<Chunk>, _: &mut Vec<Chunk>) {
        ...
        if self.chunks_stored == BUFFER_SIZE {
            ...
            let buf = self.buffer;
            self.stream.write((CHUNK_SIZE*BUFFER_SIZE) as u32, |output| {
